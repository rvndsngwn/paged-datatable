...
class PaginationResult<TPaginationKey extends Object, T extends Object> {
  ...
  PaginationResult.items({required List<T> elements, TPaginationKey? nextPageToken, int? size})
